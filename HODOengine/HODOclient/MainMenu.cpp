...
void MainMenuScene::MainMenu()
{
	...
	HDData::GameObject* temp3 = API::CreateImageBox(_scene, "tempimg", mainmenuCanvas);
	temp3->GetTransform()->SetPosition(0.f, 500.f, 0.f);
	temp3->GetComponent<HDData::ImageUI>()->SetImage("mainmenu_screen.png");
	...
	preferencesBtn->GetComponent<HDData::Button>()->SetOnClickEvent(
		[=]()
		{
			temp->GetComponent<HDData::ImageUI>()->FadeOut();
		}
	);
}
