...
void MainMenuScene::MainMenu()
{
	...
	HDData::GameObject* main_controlCanvas = API::CreateImageBox(_scene, "controlObject");
	...
	main_playText->GetComponent<HDData::TextUI>()->SetColor(DirectX::Colors::OrangeRed);
