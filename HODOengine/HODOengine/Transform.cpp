...
namespace HDData
{
	...
	Quaternion Transform::GetRotation() const
	{
		...
		return Quaternion::Concatenate(parentQuat, _rotation);
...
// 		}
	...
	void Transform::SetLocalRotationEuler(const Vector3& eulerAngle)
	{
	...
	void Transform::Rotate(float angleX, float angleY, float angleZ)
	{
		...
		//_rotation = Quaternion::Concatenate(rotQuat, _rotation);
		// 
		// 
