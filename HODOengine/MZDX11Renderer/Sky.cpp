...
{
	m_material = new Material(ResourceManager::Instance.Get().GetVertexShader("CubeMapVertexShader.cso"), ResourceManager::Instance.Get().GetPixelShader("CubeMapPixelShader.cso"));
