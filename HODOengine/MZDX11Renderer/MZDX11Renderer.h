...
extern "C" __declspec(dllexport) MZRenderer::I3DRenderer * CreateDX11GraphicsInstance();
extern "C" __declspec(dllexport) void ReleaseDX11GraphicsInstance(MZRenderer::I3DRenderer * instance);